...
#######################################################
pcrmod_cv3 <- pcr(Price ~ ., data=df_tr,validation = "CV", scale = TRUE, ncomp =5,segments = 10)
summary(pcrmod_cv)
...
#############################################################
poly_model3 <- lm(df_tr$Price~polym(AvgIncome , AvgHouseAge , AvgNumRooms , AreaPopulation,gdp_ratio,degree=2,raw=TRUE),data=df_tr1)
